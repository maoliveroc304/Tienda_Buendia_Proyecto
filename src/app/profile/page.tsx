  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-zinc-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-zinc-700">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
          <div className="col-span-1 md:col-span-2">
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="name">
              Nombre Completo
            </label>
            <input
          ...
          <div>
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="email">
              Correo Electrónico
            </label>
            <input
          ...
          <div>
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="phone">
              Teléfono Celular
            </label>
            <input
          ...
          <div>
            <div className="flex justify-between items-baseline mb-1.5">
              <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300" htmlFor="dob">
                Fecha de nacimiento
              </label>
          ...
          <div>
            <div className="flex justify-between items-baseline mb-1.5">
              <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300" htmlFor="gender">
                Sexo
              </label>
              <span className="text-xs text-gray-500 dark:text-gray-500 font-normal italic">(Opcional)</span>
            </div>
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-zinc-700">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
          <div className="md:col-span-2">
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="current_password">
              Contraseña Actual
            </label>
            <input
              className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm py-2.5 px-3 dark:bg-zinc-900 dark:border-zinc-600 dark:text-white"
          ...
          <div>
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="new_password">
              Nueva Contraseña
            </label>
            <input
              className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm py-2.5 px-3 dark:bg-zinc-900 dark:border-zinc-600 dark:text-white"
          ...
          <div>
            <label className="block text-sm font-semibold text-secondary-nav dark:text-gray-300 mb-1.5" htmlFor="confirm_password">
        ...
        <div className="space-y-4">
          <div className="group relative flex items-start gap-4 p-4 rounded-xl border border-gray-200 dark:border-zinc-600 hover:border-primary/50 hover:bg-orange-50/30 transition-all bg-gray-50/50 dark:bg-zinc-900/30">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              <button
                className="text-gray-400 hover:text-secondary-nav dark:hover:text-white p-1 hover:bg-gray-200 dark:hover:bg-zinc-700 rounded transition-colors"
                title="Editar"
              >
          ...
          <div className="group relative flex items-start gap-4 p-4 rounded-xl border border-gray-200 dark:border-zinc-600 hover:border-primary/50 hover:bg-orange-50/30 transition-all bg-gray-50/50 dark:bg-zinc-900/30">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              ...
              <button
                className="text-gray-400 hover:text-red-500 p-1 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors"
                title="Eliminar"
              >
      ...
      <div className="pt-2 flex justify-end">
        <button
          className="w-full md:w-auto px-10 py-3 bg-primary hover:bg-orange-700 text-white font-bold rounded-full shadow-lg shadow-orange-500/30 transition-all duration-200 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-primary/30 flex items-center justify-center gap-2 text-lg"
          type="button"
        >
